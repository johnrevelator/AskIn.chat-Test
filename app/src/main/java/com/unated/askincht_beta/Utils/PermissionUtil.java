...
/**
 * Created by Qhash on 23.12.2015.
 */

/**
 * Class for permissions in Android 6+
 */
public class PermissionUtil {
    ...
    /**
     * Check app for specific permission
     *
     * @param context context
     * @return true - app has permission, false - otherwise
     */
    ...
    /**
     * Request permission for <code>android.support.v4.app.Fragment</code>.
     * You must override <code>onRequestPermissionsResult</code> for catch result.
     *
    ...
    /**
     * Request permission for <code>android.app.Activity</code>.
     * You must override <code>onRequestPermissionsResult</code> for catch result.
     *
    ...
    /**
     * Check permission and run request if it need
     *
     * @param fragment     current fragment
